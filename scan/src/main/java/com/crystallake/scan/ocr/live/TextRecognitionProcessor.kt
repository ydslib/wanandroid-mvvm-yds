...
import com.crystallake.scan.ocr.process.VisionProcessorBase
...
class TextRecognitionProcessor(
    ...
    override fun onSuccess(text: Text?, graphicOverlay: GraphicOverlay?) {
        ...
        if (text?.text?.contains("Date") == true) {
            println("Date:${text.text}")
        }
    ...
    companion object {
        ...
        private const val MANUAL_TESTING_LOG = "MANUAL_TESTING_LOG"
